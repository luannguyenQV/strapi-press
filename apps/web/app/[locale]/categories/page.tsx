...
export async function generateMetadata({ params }: CategoriesProps): Promise<Metadata> {
...
export default async function CategoriesPage({ params }: CategoriesProps) {
  const { locale } = await params;
...
// No Categories Fallback Content
function NoCategoriesContent() {
  return (
