...
export async function generateMetadata({
  ...
  return createMetadata({
    title: 'About Us',
    description:
      'Learn more about StrapiPress and our mission to help businesses succeed.',
  });
}
    ...
    return (
      <div className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          {aboutData.blocks &&
          Array.isArray(aboutData.blocks) &&
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert mx-auto">
          <h2>Our Mission</h2>
          <p>
            StrapiPress combines the power of Strapi CMS with Next.js to deliver
            a fast, flexible, and developer-friendly blogging platform. We
            believe in building tools that make content management simple and
            enjoyable.
          </p>
          ...
          <ul>
            <li>
              <strong>Headless CMS:</strong> Strapi provides a powerful backend
              with full content management capabilities
            </li>
            <li>
              <strong>Modern Frontend:</strong> Next.js 15 with App Router,
              React Server Components, and Partial Prerendering
            </li>
            <li>
              <strong>Performance First:</strong> Edge caching, ISR, and
              optimized image delivery for blazing-fast load times
            </li>
            <li>
              <strong>Developer Experience:</strong> TypeScript, monorepo
          ...
          <p>
            Built with modern web technologies including Next.js 15, React 19,
            Tailwind CSS v4, Strapi 5, and TypeScript. Optimized for deployment
            on Vercel Edge Network.
          </p>

          <h2>Get Started</h2>
          <p>
            Ready to start blogging? Check out our documentation or get in touch
            with our team to learn how StrapiPress can power your content
            platform.
          </p>
        </div>
      </div>
