...
export default async function NotFound() {
  ...
  try {
    ...
    categories = (response?.data as unknown as Category[]) || [] as Category[];
  } catch (error) {
  ...
  return (
    <div className="container mx-auto flex min-h-[70vh] flex-col items-center justify-center px-4 py-16">
      <div className="max-w-2xl text-center">
        {/* 404 Illustration */}
        <div className="mb-8">
          <TypographyH1 className="text-9xl text-muted-foreground/20">404</TypographyH1>
        </div>
                ...
                >
                  <Card className="transition-all hover:shadow-md">
                    <CardContent className="p-4">
                      <TypographyH4 className="capitalize">{category.name}</TypographyH4>
