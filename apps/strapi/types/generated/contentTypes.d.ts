...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bookmarksCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bottomLinks: Schema.Attribute.Component<'footer.navigation-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    columns: Schema.Attribute.Component<'footer.navigation-column', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    copyright: Schema.Attribute.Text &
      ...
      Schema.Attribute.DefaultTo<'\u00A9 2024 StrapiPress. All rights reserved.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Organize articles with tags';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'Extended user profile for social blogging platform';
    displayName: 'User';
    name: 'user';
    pluralName: 'users';
    singularName: 'user';
  ...
  attributes: {
    ...
    following: Schema.Attribute.Relation<'oneToMany', 'api::follow.follow'>;
    likes: Schema.Attribute.Relation<'oneToMany', 'api::like.like'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
